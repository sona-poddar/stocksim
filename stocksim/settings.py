...
# Use PostgreSQL if environment variables are available, otherwise sqlite
if os.environ.get('DATABASE_URL') or os.environ.get('PGDATABASE'):
    DATABASES = {
        'default': {
...
# Yahoo Finance API key (can be None, as basic endpoints work without it)
YAHOO_FINANCE_API_KEY = os.environ.get('YAHOO_FINANCE_API_KEY', None)
